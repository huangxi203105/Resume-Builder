...
const IndexPage = () => {
  ...
  return (
    <div className="bg-[#f8fbfd] min-h-screen w-full">
        ...
        <header className="w-full fixed top-0 w-full z-50 bg-white/70 backdrop-blur-xl border-b border-violet-100/50 py-4 px-80 flex justify-between">
          ...
          <div>
            {userContext?.user ? (
              ...
              <button
                onClick={showModal}
                className="cursor-pointer bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white py-2 px-4 rounded-[15px] shadow-md overflow-hidden transition-all hover:scale-105 hover:shadow-xl hover:shadow-violet-200"
              >
      ...
      <div className="px-5 2xl:px-70 md:px-30 pt-[150px] pb-[150px]">
        <section className="flex justify-between">
          <div className="w-[50%] flex flex-col gap-6">
            ...
            <div
              data-aos="fade-up"
              data-aos-delay="300"
              className="text-7xl font-bold bg-gradient-to-r from-violet-600 to-yellow-600 bg-clip-text text-transparent"
            >
              Professional
            </div>
            <div
            ...
            <div
              data-aos="fade-up"
              data-aos-delay="500"
              className="text-xl font-normal text-[#76787f]"
            >
            ...
            <div data-aos="fade-up" data-aos-delay="600" className="flex gap-4">
              <button
                onClick={ToResumePage}
                className="w-[200px] cursor-pointer bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white py-2 px-4 rounded-[15px] shadow-md overflow-hidden transition-all hover:scale-105 hover:shadow-xl hover:shadow-violet-200"
              >
            ...
            <div className="flex gap-4">
              {statsMap.map((stat, index) => (
                ...
                >
                  <div
                    className={`text-2xl lg:text-4xl font-black bg-gradient-to-r bg-clip-text text-transparent ${stat.gradient}`}
                  >
                    {stat.value}
                  </div>
        ...
        <section className="flex gap-4 flex-col mt-[120px]">
          <div className="flex w-full justify-center items-center gap-2">
            ...
            <div
              data-aos="fade-up"
              data-aos-delay="200"
              className="text-5xl font-bold bg-gradient-to-r from-violet-600 to-fuchsia-600 bg-clip-text text-transparent"
            >
              ResumeXpert?
            </div>
          </div>
          <div className="flex w-full justify-center items-center">
            <div
              data-aos="fade-up"
              data-aos-delay="300"
              className="text-normal text-[#878ca4]"
            >
          ...
          <div className="flex flex-col w-full justify-between items-center">
            ...
            <div className="mt-[150px]">
              <div
                data-aos="fade-up"
                data-aos-delay="200"
                className="flex flex-col gap-4 justify-center bg-[#fefcfe] p-8 rounded-2xl shadow-lg shadow-violet-200"
              >
                ...
                >
                  <button
                    onClick={ToResumePage}
                    className="w-[250px] cursor-pointer bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white py-5 px-4 rounded-[15px] shadow-md overflow-hidden transition-all hover:scale-105 hover:shadow-xl hover:shadow-violet-200 hover:bg-gradient-to-r hover:from-[#d621de] hover:to-[#f7702b]"
                  >
